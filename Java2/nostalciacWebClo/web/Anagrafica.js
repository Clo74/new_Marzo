...
document.querySelector("#pSubmit").onclick = function () {
    ...
    //altrimenti carico il json e faccio la fetch
    let obj = {};

    obj.cognome = document.querySelector("#nome").value;
    obj.nome = document.querySelector("#cognome").value;
    obj.usr = document.querySelector("#username").value;
    obj.pwd = document.querySelector("#password").value;
    obj.mail = document.querySelector("#mail").value;
    obj.ruolo = "S";
    obj.citta = document.querySelector("#citta").value;
    obj.indirizzo =  document.querySelector("#indirizzo").value;
    obj.telefono =  document.querySelector("#telefono").value;
    obj.note = document.querySelector("#note").value;
    obj.dataNas = document.querySelector("#dataNas").value;
    
    fetch('http://localhost:8080/nostalciac/resources/anagrafiche', {
        method: 'POST',

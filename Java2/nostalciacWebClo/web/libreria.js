...
function creaTabellaDaJson(oggJson, listaCampi, idTabella, classeTabella, contenitore = "body", caption) {
    let tabella = document.createElement("table");
    tabella.id = idTabella;
    tabella.className = classeTabella;  //da verif
    let tagCaption = document.createElement("caption");
    tagCaption.innerHTML = "<h2>" + caption + "</h3>";
    tabella.append(tagCaption);
...
function creaTabellaDaJsonDB(oggJson, listaCampi, idTabella, classeTabella, contenitore = "body", nomeCampoId, caption) {
    let tabella = document.createElement("table");
    tabella.id = idTabella;
    tabella.className = classeTabella ; //da verif

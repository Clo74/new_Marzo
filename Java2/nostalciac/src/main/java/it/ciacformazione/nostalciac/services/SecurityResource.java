...
public class SecurityResource {
    //dentro formparam metto il name della pagina html del form
    ...
    public Response login(@FormParam("usr") String usr,@FormParam("pwd") String pwd) {
        ...
        p.ifPresent(a -> System.out.println(a.getCognome()));
       
        return p.isPresent() ?  Response.ok().build() : Response.status(Response.Status.UNAUTHORIZED).build();
